...
(function ($) {
    ...
    */
    ...
    $(window).scroll(function(){
        ...
        var trans = scroll > 255 ? 255 : scroll;
        trans = trans < 0 ? 0 : trans;
        trans /= 255;
        let color = "rgba(255,255,255,"+trans+")"

        $("#header").css("background" , color);


        // let imgTop = $('.service-banner-img-2').offset().top;
        //
        // let img1 = $('.service-banner-img-1');
        // let img2 = $('.service-banner-img-2');
        // let img3 = $('.service-banner-img-3');
        // let imgs = [];
        // if(img1 !== null){
        //     imgs.push(img1)
        // }
        ...
        //     var elementBottom = imgTop + img.outerHeight()+400;
        //     imgTop += 200;
        //     elementBottom -= 200;
        //     var viewportTop = $(window).scrollTop();
        //     var viewportBottom = viewportTop + $(window).height();
        //
        //     let opacity = img.css('opacity');
        //
        //     if(elementBottom > viewportTop && imgTop < viewportBottom){
        //         if(opacity == 0){
